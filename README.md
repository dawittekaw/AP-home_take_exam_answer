...
## Task: generate an ordered plot (i.e. from lowest to highest) of number of miRNAs / species
 ...
 ![Figure_1](https://github.com/dawittekaw/AP-home_take_exam_answer/assets/130226215/6d0fb917-4857-4aa8-b799-630e9fbc89d8)
...
# Question3b: Task: generate a plot to show which let miRNAs are present in each species.

 ![Figure_2](https://github.com/dawittekaw/AP-home_take_exam_answer/assets/130226215/2e99038c-c6d2-4d5c-9d23-a8e6c5d72047)
...
# Question 4: what is the Levenshtein distance among all pairs for human?
...
Levenshtein distance between hsa-let-7d-3p MIMAT0004484 Homo sapiens let-7d-3p and hsa-let-7a-2-3p MIMAT0010195 Homo sapiens let-7a-2-
3p: 7
...
# NB. for all other species let 7 mirnas we can generate the average levenshtein distance and plot using the code that we used to generate the average levenshtein distance of let 7 mirna and plot for human by changing the species code only.

# Question 5A: What is the levenshtein distance for each let-7 miRNA across all species?

Species: cpi-let-7a-3p - cpo-let-7a-5p | Levenshtein Distance: 13

Species: cpi-let-7a-3p - cpo-let-7a-3p | Levenshtein Distance: 2

Species: cpi-let-7a-3p - cpo-let-7a-2-3p | Levenshtein Distance: 8

Species: cpi-let-7a-3p - dno-let-7a-5p | Levenshtein Distance: 13

Species: cpi-let-7a-3p - dno-let-7a-3p | Levenshtein Distance: 2

Species: cpi-let-7a-3p - ocu-let-7a-5p | Levenshtein Distance: 13

Species: cpi-let-7a-3p - ocu-let-7a-3p | Levenshtein Distance: 2

Species: cpi-let-7a-3p - ocu-let-7a-2-3p | Levenshtein Distance: 7

Species: cpi-let-7a-3p - ppa-let-7a | Levenshtein Distance: 13

Species: cpi-let-7a-3p - mmr-let-7a | Levenshtein Distance: 13

Species: cpi-let-7a-3p - dma-let-7a | Levenshtein Distance: 13

Species: cpi-let-7a-3p - nle-let-7a | Levenshtein Distance: 13

Species: cpi-let-7a-3p - sbo-let-7a | Levenshtein Distance: 13

Species: cpi-let-7a-3p - pha-let-7a | Levenshtein Distance: 13

Species: cpi-let-7a-3p - oga-let-7a | Levenshtein Distance: 13

Species: cpi-let-7a-2-3p - cpi-let-7a-4-3p | Levenshtein Distance: 7

Species: cpi-let-7a-2-3p - ami-let-7a-5p | Levenshtein Distance: 15

Species: cpi-let-7a-2-3p - ami-let-7a-3p | Levenshtein Distance: 7

Species: cpi-let-7a-2-3p - ami-let-7a-2-3p | Levenshtein Distance: 0

Species: cpi-let-7a-2-3p - ami-let-7a-4-3p | Levenshtein Distance: 8

Species: cpi-let-7a-2-3p - cli-let-7a-5p | Levenshtein Distance: 15

Species: cpi-let-7a-2-3p - cli-let-7a-3p | Levenshtein Distance: 6

Species: cpi-let-7a-2-3p - cli-let-7a-2-3p | Levenshtein Distance: 0

Species: cpi-let-7a-2-3p - cli-let-7a-4-3p | Levenshtein Distance: 8

Species: cpi-let-7a-2-3p - pbv-let-7a-5p | Levenshtein Distance: 15

Species: cpi-let-7a-2-3p - pbv-let-7a-3p | Levenshtein Distance: 7

Species: cpi-let-7a-2-3p - pbv-let-7a-2-3p | Levenshtein Distance: 5

Species: cpi-let-7a-2-3p - chi-let-7a-5p | Levenshtein Distance: 15

Species: cpi-let-7a-2-3p - chi-let-7a-3p | Levenshtein Distance: 5

Species: cpi-let-7a-2-3p - tch-let-7a-5p | Levenshtein Distance: 15

Species: cpi-let-7a-2-3p - tch-let-7a-3p | Levenshtein Distance: 5

Species: cpi-let-7a-2-3p - oha-let-7a | Levenshtein Distance: 15

Species: cpi-let-7a-2-3p - oha-let-7a-5p | Levenshtein Distance: 15

Species: cpi-let-7a-2-3p - oha-let-7a-2-3p | Levenshtein Distance: 9

Species: cpi-let-7a-2-3p - oha-let-7a-3-3p | Levenshtein Distance: 11

Species: cpi-let-7a-2-3p - cja-let-7a | Levenshtein Distance: 15

Species: cpi-let-7a-2-3p - pal-let-7a-5p | Levenshtein Distance: 15

Species: cpi-let-7a-2-3p - pal-let-7a-3p | Levenshtein Distance: 5

Species: cpi-let-7a-2-3p - pal-let-7a-2-3p | Levenshtein Distance: 1

Species: cpi-let-7a-2-3p - cgr-let-7a-2 | Levenshtein Distance: 1

Species: cpi-let-7a-2-3p - abu-let-7a | Levenshtein Distance: 15

Species: cpi-let-7a-2-3p - mze-let-7a | Levenshtein Distance: 15

Species: cpi-let-7a-2-3p - nbr-let-7a | Levenshtein Distance: 15

Species: cpi-let-7a-2-3p - oni-let-7a | Levenshtein Distance: 15

Species: cpi-let-7a-2-3p - pny-let-7a | Levenshtein Distance: 15

Species: cpi-let-7a-2-3p - gmo-let-7a-5p | Levenshtein Distance: 15

Species: cpi-let-7a-2-3p - gmo-let-7a-3-3p | Levenshtein Distance: 6

Species: cpi-let-7a-2-3p - gmo-let-7a-4-3p | Levenshtein Distance: 8

Species: cpi-let-7a-2-3p - gmo-let-7a-5-3p | Levenshtein Distance: 8

Species: cpi-let-7a-2-3p - gmo-let-7a-3p | Levenshtein Distance: 2

Species: cpi-let-7a-2-3p - xla-let-7a-5p | Levenshtein Distance: 15

Species: cpi-let-7a-2-3p - xla-let-7a-3p | Levenshtein Distance: 2

Species: cpi-let-7a-2-3p - cpo-let-7a-5p | Levenshtein Distance: 15

Species: cpi-let-7a-2-3p - cpo-let-7a-3p | Levenshtein Distance: 5

Species: cpi-let-7a-2-3p - cpo-let-7a-2-3p | Levenshtein Distance: 1

Species: cpi-let-7a-2-3p - dno-let-7a-5p | Levenshtein Distance: 15

Species: cpi-let-7a-2-3p - dno-let-7a-3p | Levenshtein Distance: 5

Species: cpi-let-7a-2-3p - ocu-let-7a-5p | Levenshtein Distance: 15

Species: cpi-let-7a-2-3p - ocu-let-7a-3p | Levenshtein Distance: 5

Species: cpi-let-7a-2-3p - ocu-let-7a-2-3p | Levenshtein Distance: 0

Species: cpi-let-7a-2-3p - ppa-let-7a | Levenshtein Distance: 15

Species: cpi-let-7a-2-3p - mmr-let-7a | Levenshtein Distance: 15

Species: cpi-let-7a-2-3p - dma-let-7a | Levenshtein Distance: 15

Species: cpi-let-7a-2-3p - nle-let-7a | Levenshtein Distance: 15

Species: cpi-let-7a-2-3p - sbo-let-7a | Levenshtein Distance: 15

Species: cpi-let-7a-2-3p - pha-let-7a | Levenshtein Distance: 15

Species: cpi-let-7a-2-3p - oga-let-7a | Levenshtein Distance: 15

Species: cpi-let-7a-4-3p - ami-let-7a-5p | Levenshtein Distance: 14

Species: cpi-let-7a-4-3p - ami-let-7a-3p | Levenshtein Distance: 5

Species: cpi-let-7a-4-3p - ami-let-7a-2-3p | Levenshtein Distance: 7

Species: cpi-let-7a-4-3p - ami-let-7a-4-3p | Levenshtein Distance: 1

Species: cpi-let-7a-4-3p - cli-let-7a-5p | Levenshtein Distance: 14

Species: cpi-let-7a-4-3p - cli-let-7a-3p | Levenshtein Distance: 4

Species: cpi-let-7a-4-3p - cli-let-7a-2-3p | Levenshtein Distance: 7

Species: cpi-let-7a-4-3p - cli-let-7a-4-3p | Levenshtein Distance: 1

Species: cpi-let-7a-4-3p - pbv-let-7a-5p | Levenshtein Distance: 14

Species: cpi-let-7a-4-3p - pbv-let-7a-3p | Levenshtein Distance: 3

Species: cpi-let-7a-4-3p - pbv-let-7a-2-3p | Levenshtein Distance: 4

Species: cpi-let-7a-4-3p - chi-let-7a-5p | Levenshtein Distance: 14

Species: cpi-let-7a-4-3p - chi-let-7a-3p | Levenshtein Distance: 4

Species: cpi-let-7a-4-3p - tch-let-7a-5p | Levenshtein Distance: 13

Species: cpi-let-7a-4-3p - tch-let-7a-3p | Levenshtein Distance: 4

Species: cpi-let-7a-4-3p - oha-let-7a | Levenshtein Distance: 14

Species: cpi-let-7a-4-3p - oha-let-7a-5p | Levenshtein Distance: 14

Species: cpi-let-7a-4-3p - oha-let-7a-2-3p | Levenshtein Distance: 7

Species: cpi-let-7a-4-3p - oha-let-7a-3-3p | Levenshtein Distance: 5

Species: cpi-let-7a-4-3p - cja-let-7a | Levenshtein Distance: 14

Species: cpi-let-7a-4-3p - pal-let-7a-5p | Levenshtein Distance: 14

Species: cpi-let-7a-4-3p - pal-let-7a-3p | Levenshtein Distance: 4

Species: cpi-let-7a-4-3p - pal-let-7a-2-3p | Levenshtein Distance: 6

Species: cpi-let-7a-4-3p - cgr-let-7a-2 | Levenshtein Distance: 6

Species: cpi-let-7a-4-3p - abu-let-7a | Levenshtein Distance: 14

Species: cpi-let-7a-4-3p - mze-let-7a | Levenshtein Distance: 14

Species: cpi-let-7a-4-3p - nbr-let-7a | Levenshtein Distance: 14

Species: cpi-let-7a-4-3p - oni-let-7a | Levenshtein Distance: 14

Species: cpi-let-7a-4-3p - pny-let-7a | Levenshtein Distance: 14

Species: cpi-let-7a-4-3p - gmo-let-7a-5p | Levenshtein Distance: 14

Species: cpi-let-7a-4-3p - gmo-let-7a-3-3p | Levenshtein Distance: 6

Species: cpi-let-7a-4-3p - gmo-let-7a-4-3p | Levenshtein Distance: 3

Species: cpi-let-7a-4-3p - gmo-let-7a-5-3p | Levenshtein Distance: 1

Species: cpi-let-7a-4-3p - gmo-let-7a-3p | Levenshtein Distance: 7

Species: cpi-let-7a-4-3p - xla-let-7a-5p | Levenshtein Distance: 14

Species: cpi-let-7a-4-3p - xla-let-7a-3p | Levenshtein Distance: 7

Species: cpi-let-7a-4-3p - cpo-let-7a-5p | Levenshtein Distance: 14

Species: cpi-let-7a-4-3p - cpo-let-7a-3p | Levenshtein Distance: 4

Species: cpi-let-7a-4-3p - cpo-let-7a-2-3p | Levenshtein Distance: 6

Species: cpi-let-7a-4-3p - dno-let-7a-5p | Levenshtein Distance: 14

Species: cpi-let-7a-4-3p - dno-let-7a-3p | Levenshtein Distance: 4

Species: cpi-let-7a-4-3p - ocu-let-7a-5p | Levenshtein Distance: 14

Species: cpi-let-7a-4-3p - ocu-let-7a-3p | Levenshtein Distance: 4

Species: cpi-let-7a-4-3p - ocu-let-7a-2-3p | Levenshtein Distance: 7

Species: cpi-let-7a-4-3p - ppa-let-7a | Levenshtein Distance: 14

Species: cpi-let-7a-4-3p - mmr-let-7a | Levenshtein Distance: 14

Species: cpi-let-7a-4-3p - dma-let-7a | Levenshtein Distance: 14

Species: cpi-let-7a-4-3p - nle-let-7a | Levenshtein Distance: 14

Species: cpi-let-7a-4-3p - sbo-let-7a | Levenshtein Distance: 14

Species: cpi-let-7a-4-3p - pha-let-7a | Levenshtein Distance: 14

Species: cpi-let-7a-4-3p - oga-let-7a | Levenshtein Distance: 14

Species: ami-let-7a-5p - ami-let-7a-3p | Levenshtein Distance: 13

Species: ami-let-7a-5p - ami-let-7a-2-3p | Levenshtein Distance: 15

Species: ami-let-7a-5p - ami-let-7a-4-3p | Levenshtein Distance: 13

Species: ami-let-7a-5p - cli-let-7a-5p | Levenshtein Distance: 0

Species: ami-let-7a-5p - cli-let-7a-3p | Levenshtein Distance: 14

Species: ami-let-7a-5p - cli-let-7a-2-3p | Levenshtein Distance: 15

Species: ami-let-7a-5p - cli-let-7a-4-3p | Levenshtein Distance: 13

Species: ami-let-7a-5p - pbv-let-7a-5p | Levenshtein Distance: 0

Species: ami-let-7a-5p - pbv-let-7a-3p | Levenshtein Distance: 13

Species: ami-let-7a-5p - pbv-let-7a-2-3p | Levenshtein Distance: 15

Species: ami-let-7a-5p - chi-let-7a-5p | Levenshtein Distance: 0

Species: ami-let-7a-5p - chi-let-7a-3p | Levenshtein Distance: 15

Species: ami-let-7a-5p - tch-let-7a-5p | Levenshtein Distance: 2

Species: ami-let-7a-5p - tch-let-7a-3p | Levenshtein Distance: 15

Species: ami-let-7a-5p - oha-let-7a | Levenshtein Distance: 0

Species: ami-let-7a-5p - oha-let-7a-5p | Levenshtein Distance: 0

Species: ami-let-7a-5p - oha-let-7a-2-3p | Levenshtein Distance: 14

Species: ami-let-7a-5p - oha-let-7a-3-3p | Levenshtein Distance: 12

Species: ami-let-7a-5p - cja-let-7a | Levenshtein Distance: 0

Species: ami-let-7a-5p - pal-let-7a-5p | Levenshtein Distance: 0

Species: ami-let-7a-5p - pal-let-7a-3p | Levenshtein Distance: 15

Species: ami-let-7a-5p - pal-let-7a-2-3p | Levenshtein Distance: 15

Species: ami-let-7a-5p - cgr-let-7a-2 | Levenshtein Distance: 15

Species: ami-let-7a-5p - abu-let-7a | Levenshtein Distance: 0

Species: ami-let-7a-5p - mze-let-7a | Levenshtein Distance: 0

Species: ami-let-7a-5p - nbr-let-7a | Levenshtein Distance: 0

Species: ami-let-7a-5p - oni-let-7a | Levenshtein Distance: 0

Species: ami-let-7a-5p - pny-let-7a | Levenshtein Distance: 0

Species: ami-let-7a-5p - gmo-let-7a-5p | Levenshtein Distance: 0

Species: ami-let-7a-5p - gmo-let-7a-3-3p | Levenshtein Distance: 14

Species: ami-let-7a-5p - gmo-let-7a-4-3p | Levenshtein Distance: 14

Species: ami-let-7a-5p - gmo-let-7a-5-3p | Levenshtein Distance: 14

Species: ami-let-7a-5p - gmo-let-7a-3p | Levenshtein Distance: 14

Species: ami-let-7a-5p - xla-let-7a-5p | Levenshtein Distance: 0

Species: ami-let-7a-5p - xla-let-7a-3p | Levenshtein Distance: 14

Species: ami-let-7a-5p - cpo-let-7a-5p | Levenshtein Distance: 0

Species: ami-let-7a-5p - cpo-let-7a-3p | Levenshtein Distance: 15

Species: ami-let-7a-5p - cpo-let-7a-2-3p | Levenshtein Distance: 15

Species: ami-let-7a-5p - dno-let-7a-5p | Levenshtein Distance: 0

Species: ami-let-7a-5p - dno-let-7a-3p | Levenshtein Distance: 15

Species: ami-let-7a-5p - ocu-let-7a-5p | Levenshtein Distance: 0

Species: ami-let-7a-5p - ocu-let-7a-3p | Levenshtein Distance: 15

Species: ami-let-7a-5p - ocu-let-7a-2-3p | Levenshtein Distance: 15

Species: ami-let-7a-5p - ppa-let-7a | Levenshtein Distance: 0

Species: ami-let-7a-5p - mmr-let-7a | Levenshtein Distance: 0

Species: ami-let-7a-5p - dma-let-7a | Levenshtein Distance: 0

Species: ami-let-7a-5p - nle-let-7a | Levenshtein Distance: 0

Species: ami-let-7a-5p - sbo-let-7a | Levenshtein Distance: 0

Species: ami-let-7a-5p - pha-let-7a | Levenshtein Distance: 0

Species: ami-let-7a-5p - oga-let-7a | Levenshtein Distance: 0

Species: ami-let-7a-3p - ami-let-7a-2-3p | Levenshtein Distance: 7

Species: ami-let-7a-3p - ami-let-7a-4-3p | Levenshtein Distance: 4

Species: ami-let-7a-3p - cli-let-7a-5p | Levenshtein Distance: 13

Species: ami-let-7a-3p - cli-let-7a-3p | Levenshtein Distance: 1

Species: ami-let-7a-3p - cli-let-7a-2-3p | Levenshtein Distance: 7

Species: ami-let-7a-3p - cli-let-7a-4-3p | Levenshtein Distance: 5

Species: ami-let-7a-3p - pbv-let-7a-5p | Levenshtein Distance: 13

Species: ami-let-7a-3p - pbv-let-7a-3p | Levenshtein Distance: 2

Species: ami-let-7a-3p - pbv-let-7a-2-3p | Levenshtein Distance: 2

Species: ami-let-7a-3p - chi-let-7a-5p | Levenshtein Distance: 13
...
# Repeat for all let-7 miRNAs 

# NB. To Repeat this code across all species please change the let 7 code in the code that generates the above output for each let 7 mirnas code across each speies.

# Q5B:what is the average Levenshtein distance for each let-7 miRNA among all pairs and plot?
...
![Figure_4](https://github.com/dawittekaw/AP-home_take_exam_answer/assets/130226215/963e63c6-55ae-48fb-a0ab-16b41ed03219)
